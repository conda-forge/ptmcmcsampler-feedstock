...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ptmcmcsampler-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12243&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ptmcmcsampler-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ptmcmcsampler` can be installed with:

```
conda install ptmcmcsampler
```

It is possible to list all of the versions of `ptmcmcsampler` available on your platform with:
